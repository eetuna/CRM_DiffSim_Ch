...
- No CP-1-specific acceptance criteria are defined in the spec. PR-1 acceptance criteria are satisfied (see `docs/autodiff_audits/PR-1_completion.md`).
