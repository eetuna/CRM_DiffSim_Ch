...
#define RESIDUAL_SCALE_F	0.01 //(10.0)			// the residual for tip FORCE coming out of the IVP will be multiplied with this scale to return to the Nonlinear Solver
