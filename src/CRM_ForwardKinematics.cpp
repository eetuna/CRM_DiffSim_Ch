...
namespace CRMCatheterModel {
	...
	VectorXd CRM_ForwardKinematics_FreeSpace(const VectorXd in_x, CRMForwardKinematicsData Params, double& out_PotentialEnergy, int& out_localmin) {
		...
		CRMSolverIVP(BVPParams, deltau0_calc, ftip_calc, CalculateEnergy, Params.FinalValueOnly, xf, residual, out_PotentialEnergy, Params.ReportedMarkerPos, Params.ReportedCoilOrient, Params.ReportedCoilPos);
