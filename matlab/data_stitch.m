...
path_to_output = '3D_dynamic_response_data_0124/output_trajectories/circle100_01.txt';
path_to_input = '3D_dynamic_response_data_0124/input_currents/circleCurrents.mat';
Ts = 0.1; %s
...
path_to_output = '3D_dynamic_response_data_0124/output_trajectories/circle50_01.txt';
path_to_input = '3D_dynamic_response_data_0124/input_currents/circleCurrents.mat';
Ts = 0.05; %s
...
path_to_output = '3D_dynamic_response_data_0124/output_trajectories/circle25_01.txt';
path_to_input = '3D_dynamic_response_data_0124/input_currents/circleCurrents.mat';
Ts = 0.025; %s
...
time_ = [time_, t_25];
% 
path_to_output = '3D_dynamic_response_data_0124/output_trajectories/circle20_01.txt';
path_to_input = '3D_dynamic_response_data_0124/input_currents/circleCurrents.mat';
Ts = 0.02; %s
...
path_to_output = '3D_dynamic_response_data_0124/output_trajectories/circle18_01.txt';
path_to_input = '3D_dynamic_response_data_0124/input_currents/circleCurrents.mat';
Ts = 0.018; %s
...
time_ = [time_, t_18];
% 
path_to_output = '3D_dynamic_response_data_0124/output_trajectories/circle15_01.txt';
path_to_input = '3D_dynamic_response_data_0124/input_currents/circleCurrents.mat';
Ts = 0.015; %s
...
time_ = [time_, t_15];
% % 
% path_to_output = '3D_dynamic_response_data_0124/output_trajectories/circle12_01.txt';
% path_to_input = '3D_dynamic_response_data_0124/input_currents/circleCurrents.mat';
% Ts = 0.012; %s
...
% 
% path_to_output = '3D_dynamic_response_data_0124/output_trajectories/circle10_01.txt';
% path_to_input = '3D_dynamic_response_data_0124/input_currents/circleCurrents.mat';
% Ts = 0.01; %s
...
load('3D_dynamic_response_data_0124/input_currents/circleCurrents.mat');
...
% 
save('output_data/tip_position_new.mat','tip_position_mat');
save('output_data/currents_new.mat','currents_mat');