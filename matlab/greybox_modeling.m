...
vL = [0;0;0];
wL = [0;0;0];
u0 =[0.000799849479553773; -0.0002292201697658481; 0;0.0148626102272827; 0.0094448815853795; 0];% [0.000719849479553773; -0.0003292201697658481; 0];
nL = [0;0;0];
mL = [0;0;0];
