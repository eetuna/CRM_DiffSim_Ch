function DrawCRMCatheterModel(FKParams, control_inputs, varargin); % ReportedMarkerPos, ReportedCoilOrient, segment_steps)
...
%
    ...
    if (nargin ~=5)
        ...
        %
        [~, ~, ReportedMarkerPos, ReportedCoilOrient, ~] = CRM_ForwardKinematics_matlab(control_inputs, FKParamsRevised);
        ...
        ReportedCoilOrient=varargin{2};
        segment_steps=varargin{3};
    end
